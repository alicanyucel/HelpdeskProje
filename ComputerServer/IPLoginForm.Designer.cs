namespace ComputerServer
{
	partial class IPLoginForm
	{
		...
		private void InitializeComponent()
		{
			...
			// IPAdress
			// 
			this.IPAdress.Location = new System.Drawing.Point(109, 122);
			this.IPAdress.Name = "IPAdress";
			this.IPAdress.Size = new System.Drawing.Size(122, 22);
			this.IPAdress.TabIndex = 1;
			this.IPAdress.Text = "192.168.1.1";
			this.IPAdress.TextChanged += new System.EventHandler(this.IPAdress_TextChanged);
			// 
			// ConnectButton
			// 
			this.ConnectButton.Enabled = false;
			this.ConnectButton.Location = new System.Drawing.Point(130, 211);
			this.ConnectButton.Name = "ConnectButton";
			this.ConnectButton.Size = new System.Drawing.Size(99, 34);
			...
			// PortNumber
			// 
			this.PortNumber.Location = new System.Drawing.Point(109, 180);
			...
			this.PortNumber.Size = new System.Drawing.Size(120, 22);
			...
			this.label3.Size = new System.Drawing.Size(247, 66);
			this.label3.TabIndex = 5;
			this.label3.Text = "Sunucuya Bağlanmak İçin\r\nYerel Sunucunun Ip Adresini  \r\nVe Portunu Girin";
			// 
			// label4
			// 
			...
			this.button1.Text = "Kilidi Kaldır";
			...
			this.Name = "IPLoginForm";
			this.ShowIcon = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Bağlantı";
			this.Load += new System.EventHandler(this.IPLoginForm_Load);
